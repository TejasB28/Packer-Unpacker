...
class PackUnpackLogin extends Template implements ActionListener,Runnable
{
	JButton SUBMIT;
	...
	PackUnpackLogin()
	{
		...
		TopLabel.setText("Packer-Unpacker System : Login");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource() == SUBMIT)
		{
			if(validate(value1,value2) == false)
			{
				text1.setText("");
				text2.setText("");
				JOptionPane.showMessageDialog(this,"Short username","Packer-Unpacker System",JOptionPane.ERROR_MESSAGE);
			}
			...
			else
			{
				...
				if(attempt == 0)
				{
					JOptionPane.showMessageDialog(this,"Number of attempts finished","Packer-Unpacker System",JOptionPane.ERROR_MESSAGE);
					this.dispose();
					System.exit(0);
				}
...
class Packer_Unpacker
{
	public static void main(String args[])
	{
		try
		{
			PackUnpackLogin frame = new PackUnpackLogin();
